...
class pointMassSim():
    ...
    def calc_state(self):
        ...
        return_dict = {
            ...
            'obs_rpy_inc_obj':  np.concatenate([state[0:3], p.getEulerFromQuaternion(state[3:7]), state[7:11],
                p.getEulerFromQuaternion(state[11:15]), state[15:]]).copy(),
            'proprioception':  arm_state['proprioception']
        }
